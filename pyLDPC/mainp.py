...
import Puncturer
import Interleaver
import Scrambler, LayerMapper,Allocater,OFDM, Precoder, MIMO
import DBPSK
...
LCP = Nifft//4 if CP==1 else (9*Nifft//128,(9+2**args.mu)*Nifft//128)
...
mnt      =  py_aff3ct.module.monitor.Monitor_BFER_AR(args.A, 50,50)
...
ofdm["modulate"].debug = True
ofdm["modulate"].set_debug_limit(10)
